      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              className="text-base sm:text-lg lg:text-justify text-gray-400 leading-relaxed text-left pb-4 sm:pb-0"
              data-aos="fade-right"
              data-aos-duration="1500"
            >
            I am a 4th-year Software Engineering student with a strong interest in backend and web development. I am passionate about creating efficient and scalable solutions, and I always strive to deliver the best results in every project I work on. I am eager to grow my skills in backend development while contributing to impactful web applications.
            </p>
