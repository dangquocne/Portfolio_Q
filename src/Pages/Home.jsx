...
const TECH_STACK = ["Java", "Spring Boot", "Vue.js", "MySQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/dangquocne" },
  { icon: Linkedin, link: "hhttps://github.com/dangquocne" },
  { icon: Instagram, link: "https://github.com/dangquocne" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                 Developing Robust, Scalable, and User-Friendly Backend Solutions for Web Applications.
                </p>
